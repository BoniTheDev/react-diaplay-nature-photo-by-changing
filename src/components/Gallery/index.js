...
class Gallery extends Component {
  ...
  getDisplayImage = id => {
    this.setState({
      displayImage: imagesList[id].imageUrl,
      displayAlt: imagesList[id].imageAltText,
    })
  }
    ...
    return (
      <div className="gallery-container">
        <div className="photo-container">
          <img className="image-size" src={displayImage} alt={displayAlt} />
        </div>
          ...
          <ul className="thumbnail-list">
            {imagesList.map(eachImageDetails => (
              <ThumbnailItem
                ...
                getDisplayImage={this.getDisplayImage}
              />
            ))}
          </ul>
        </div>
